# Color Palette Generator — Harmonic Schemes & Lightness Shades

> Generate complementary, analogous, triadic, and monochromatic shade palettes from any hex color code online. 100% client-side.

[![Live Web App](https://img.shields.io/badge/Web_App-Live_Demo-3B82F6?style=flat-square)](https://cig13zs.github.io/color-palette/)
[![Chrome Extension](https://img.shields.io/badge/Chrome_Extension-Manifest_V3-10B981?style=flat-square)](https://github.com/cig13zs/color-palette/releases)
...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/color-palette/](https://cig13zs.github.io/color-palette/) or install the offline Chrome Extension package.
...
Enter any base Hex color code (e.g. #3b82f6) to generate harmonious complementary, analogous, triadic schemes, and tint/shade scales.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/color-palette.git
   ```
